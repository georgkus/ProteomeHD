...
- <b> Orthogonal_Methods.R </b> This script compares protein - protein associations detected by co-regulation with those found in STRING, BioGRID, IntAct and BioPlex 2.0. It uses downloaded files from these databases as input, which can be found on the respective websites (too big to be uploaded here). These include <i> 9606.protein.links.detailed.v10.5.txt, BIOGRID-ALL-3.4.152.tab2.txt, 
